<template>
    ...
    <div class="box2">
        ...
        <el-icon @click="quanping" ><FullScreen class="fangdaicon" /></el-icon>
...
import { defineComponent, ref, reactive, onMounted, onBeforeUnmount, toRefs } from "vue"
...
export default defineComponent({
    setup() {
        ...
        const echarsinti = async () => {
            ...
            myChart.showLoading();
            await jq.get('gexf/01.gexf', function (xml: any) {
                myChart.hideLoading();
        ...
        return { virusimg, virusname, Back, size, back, quanping, xiangxitu, xitu }
    }
})
</script>
